...
[306, 'Ahmedabad', '23.03 N', '72.58 E', 'Gujarat'],
...
[991, 'Dehradun', '30.34 N', '78.05 E', 'Uttaranchal'],
...
const citiesName=cities.filter((city)=>!city[2]=='').map((city)=>({id:city[0],name:city[1]}));
